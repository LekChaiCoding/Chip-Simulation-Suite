...
# ─────────────────────────────────────────────────────────────────────────────
# `build_comsol_model` and `run_stub_length_sweep` moved to `jtwpa/comsol.py`
# on 2026-08-04: both hardcode one device family's vendored geometry, and both
# were already deprecated in favour of the device-agnostic forms below
# (`run_custom_comsol_build`, `run_geometry_param_sweep`). `_preflight` and
# `_start_solve` stay here and are imported by that module — they are shared
# solve plumbing, not device-specific.
# ─────────────────────────────────────────────────────────────────────────────
# ─────────────────────────────────────────────────────────────────────────────
